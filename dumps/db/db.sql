...
CREATE TABLE `AUCTION` (
  ...
  `is_product_sold` char(1) DEFAULT NULL,
...
INSERT INTO `AUCTION` VALUES (1,'2023-07-05 12:00:00','2023-07-05 12:00:00','Y','Y',1),(2,'2023-07-05 12:05:00','2023-07-05 12:28:40','Y','N',2),(3,'2023-06-04 06:34:12','2023-06-05 06:30:17','Y','N',3),(4,'2023-05-05 08:45:33','2023-05-05 17:02:45','Y','N',4),(5,'2023-05-06 10:00:00','2023-05-06 10:50:00','N','Y',5),(6,'2023-05-07 11:00:40','2023-05-07 15:52:07','N','Y',5),(7,'2023-05-27 10:00:00','2023-05-27 16:39:12','Y','N',6),(8,'2023-05-06 12:09:21',NULL,'N','N',5);
...
CREATE TABLE `ORDER` (
  ...
  `bought_from_threshold` char(1) DEFAULT NULL,
...
INSERT INTO `ORDER` VALUES (1,'2023-07-05 12:30:00',55,'N',1,2),(2,'2023-06-05 06:34:12',100,'N',2,3),(3,'2023-05-05 17:04:17',150,'N',2,4),(4,'2023-05-26 16:00:00',20,'Y',1,6);
...
INSERT INTO `THRESHOLD` VALUES (1,15,'2023-07-05 11:20:00',4,8);
...
INSERT INTO `USER` VALUES (1,'Mario12','pass','Mario','Rossi','1980-10-10','Via Mazzini',12,32767,'Venezia','Italia','mario12@gmail.com','+393458874500','SuperAdmin','N'),(2,'Giulia88','pass','Giulia','Bianchi','1995-05-15','Via Roma',25,32767,'Firenze','Italia','giulia88@gmail.com','+393331234567','Default','N'),(3,'JohnDoe','pass','John','Doe','1988-07-20','123 Main St',10,12345,'New York','USA','johndoe@example.com','+12015551234','Default','N'),(4,'Laura87','pass','Laura','Verdi','2000-12-01','Via Garibaldi',8,20121,'Venezia','Italia','laura87@example.com','+393299876543','Default','N');
...
-- Dump completed on 2024-08-10 10:57:56
